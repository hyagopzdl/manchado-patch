        ...
        function ChampionshipRulesModal({ tournament, onClose }) {
          ...
          return React.createElement(ee,{title:"Regras da competição",onClose},
            ...
            !isCup&&section("💸","Mercado",React.createElement(React.Fragment,null,
              ...
              React.createElement("div",{style:{marginTop:10,padding:12,borderRadius:14,background:"var(--surface)",border:"1px solid var(--border)",fontSize:11.5,color:"var(--muted)",lineHeight:1.5}},balance.enabled===true?`A contratação é bloqueada quando faria a diferença de overall médio entre o elenco mais forte e o mais fraco ultrapassar ${Number(balance.maxDifference!=null?balance.maxDifference:10)} pontos. Se a diferença já estiver acima do limite, só são permitidas operações que não aumentem ainda mais esse desequilíbrio.`:"A trava de equilíbrio entre os elencos está desativada nesta competição."),
