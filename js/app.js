        ...
        function HeadToHeadStats({ tournament, currentTeam, opponentTeam, profiles, teams, tournaments = [], onOpenChampionshipSummary }) {
          ...
          return React.createElement("div",null,
            React.createElement("section",{className:"family-card",style:{padding:"clamp(18px,4vw,26px)",marginBottom:16}},
              React.createElement("div",{style:{display:"grid",gridTemplateColumns:"1fr auto 1fr",alignItems:"center",gap:14,marginBottom:16}},
                React.createElement("div",{style:{display:"flex",flexDirection:"column",alignItems:"flex-start",gap:7,minWidth:0}},avatarForTeam(currentTeam,48),React.createElement("strong",{style:{fontSize:14,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",maxWidth:"100%"}},currentProfile.name||currentTeam.name)),
                React.createElement("div",{style:{fontSize:11,color:"var(--muted)",fontWeight:750,whiteSpace:"nowrap",alignSelf:"center"}},`${totalMatches} ${totalMatches===1?"confronto":"confrontos"}`),
                React.createElement("div",{style:{display:"flex",flexDirection:"column",alignItems:"flex-end",gap:7,minWidth:0}},avatarForTeam(opponentTeam,48),React.createElement("strong",{style:{fontSize:14,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",textAlign:"right",maxWidth:"100%"}},opponentProfile.name||opponentTeam.name))
              ),
